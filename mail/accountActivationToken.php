...
$URL = Url::to(['site/activate','authKey'=>$user->authKey]);
?>
				...
				<table style="border-spacing:0px;width:590px;background:inherit;color:inherit" cellspacing="0" cellpadding="0">
					<tbody>
						<tr>
							...
							<img src="css/images/logo.png" style="padding: 20px; margin: 0px; height: auto; max-width:200px;" alt="<?= Yii::$app->name; ?>" data-original-title="" title="">
							</td>
						</tr>
					</tbody>
				</table>
                        ...
                        <a href="<?php echo $URL;?>">
                            <button type="button" style="padding: 3px 3px 3px 3px;
                              ...
                              cursor: pointer;
                    					...
                    					min-width: 100px;
															min-height: 30px;
                    					text-shadow: 1px 1px 2px black;"><?php echo Yii::t('app','Register');?></button>
                        </a>
